<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="briefcase"></i><span>{{ __('retailersidebar.product') }}</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('retailer.products') }}">{{ __('retailersidebar.products') }}</a></li>
                    <li><a class="nav-link" href="{{ route('retailer.addproduct') }}">{{ __('retailersidebar.addproduct') }}</a></li>
                </ul>
            </li>
            <li class="dropdown">
